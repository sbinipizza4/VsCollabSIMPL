...
function onCreate()
         makeLuaSprite('win', 'achievements/SIMPL', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'Uh pretty good!', 200, 120, 10) -- change your title text
         setTextSize('text', '25') --text size 
         setTextColor('text', '00ffff') --change color in hex
         setObjectCamera('text', 'other')
         setProperty('text.alpha', 0)
         addLuaText('text', true)

         makeLuaText('text2', 'Beat Week SIMPL with No Misses', 200, 120, 40) -- change your description text
